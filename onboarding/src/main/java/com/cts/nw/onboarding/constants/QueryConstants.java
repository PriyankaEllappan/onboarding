...
public class QueryConstants {
	 ...
	 public static final String MAILATTACHMENT_SELECT = "SELECT ID,FILENAME,FILEDATA FROM MAILATTACHMENTS ";
	 ...
	 public static final String EMPPROJECTHIST_INSERT = "INSERT INTO EMPLOYEEPROJECTHISTORY(ID,EMPLOYEEID,PROJECT,TEAM,BSA,ROLE,COUNTRY,STARTDATE,MOVEMENTID,EXPERIENCE,SKILLSET,SKILLSUMMARY,APPROVALSTATUS,RELEASESTATUS,ONBOARDREQUESTER) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";

...
public class QueryConstants {
	 ...
	 public static final String EMPPROJECTHIST_INSERT = "INSERT INTO EMPLOYEEPROJECTHISTORY(ID,EMPLOYEEID,PROJECT,TEAM,ROLE,COUNTRY,STARTDATE,MOVEMENTID,EXPERIENCE,SKILLSET,SKILLSUMMARY,APPROVALSTATUS,RELEASESTATUS,ONBOARDREQUESTER) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?)";

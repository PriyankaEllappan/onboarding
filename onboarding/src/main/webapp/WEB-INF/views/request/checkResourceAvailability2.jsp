				...
				<div class="form-group">
					<div class="row">
						...
						<div class="col-md-3">
					 	 ...
					 	 <span class="has-error"> <span id="empId" class="help-inline" > </span>
						</span> 
						</div>
						...
						<div class="col-md-3">
							<input class="form-control" id="newEmpName" name="newEmpName"
							 ...
							 <span class="has-error"><span id="empFullName" class="help-inline" ></span></span>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="row">
						...
						<div class="col-md-10" style="text-align: center">
							<button class="btn btn-info" onclick="return registerEmployee()" > Submit </button>
